...
/datum/special/notafraid
	...
	descriptionen = "Ты не боишься упасть, потому что знаешь, как правильно приземлиться."

/datum/special/weed
	name = "weedstrong"
	description = "Maconha te deixa mais forte e mais inteligente."
	descriptionen = "Травка делает тебя сильнее, быстрее и умнее."
...
/datum/special/squireheir
	...
	descriptionen = "Ты притворяешься, что стал будущим Мардуком."
...
/datum/special/comicsans
	...
	descriptionen = "У тебя неприятный голос."

/datum/special/mayartist
	name = "mayartist"
	descriptionen = "Сегодня твоя счастливая ночь. Вы потратили несколько дней на то, чтобы развить свои навыки рисования, и сегодня вечером вы могли бы добиться большого успеха."

/datum/special/afraidmed
	name = "afraidmed"
	description = "It's better to die than to be healed like this. You're afraid of doctors and medicine."
	descriptionen = "Лучше умереть, чем получить такое исцеление. Ты боишься врачей и лекарств."
...
/datum/special/bouncer
	...
	descriptionen = "Ты вышибала. Вы презираете закон, но любите наводить порядок. Ты также любишь своего босса-братана-толкача, и ты раздавишь каждого, кто посмеет проявить неуважение к нему или его месту."
...
/datum/special/childworker
	...
	descriptionen = "Вы всё свое детство проработали рабочим на стройплощадке."
...
/datum/special/michaelshepard
	...
	descriptionen = "Майкл Шепард."

/datum/special/proficientkicker
	description = "Você chuta muito bem."
	descriptionen = "Ты опытный футболист."

/datum/special/hygiene
	name = "hygiene"
	description = "Você é bem fedido."
	descriptionen = "От тебя ужасно пахнет, и ты ничего не можешь с этим поделать."

/datum/special/blueblood
	name = "blueblood"
	description = "Você vem de uma família nobre no norte, você é de sangue nobre."
	descriptionen = "Ты происходишь из благородной семьи с севера, в тебе благородная кровь."
...
/datum/special/weirdregurgi
	...
	descriptionen = "Вы одержимы странным сном, в котором вас ловит срыгиватель."
...
/datum/special/dst
	...
	descriptionen = "Вы носитель смертельного ЗППП. Подарите его 6 счастливчикам. Выживите."
	reward = "10 Хромосом"
	rewarden = "10 Хромосом"
...
/datum/special/unmarriedwoman
	...
	descriptionen = "Найди себе мужа. Улетайте на шаттле или купите билет до Винфорта."
...
/datum/special/orphanbum
	...
	descriptionen = "Вы агент Сирот, запрещенной организации. Общество думает, что вы - чистое зло, что вы хуже еретиков. Но у вас только благие намерения, и вы на правильном пути к поиску истины - вся ложь против вас только подтверждает это. Завершите свою миссию и сбежите на шаттле или купите билет до Винфорта."
	reward = "5 Cromossomos"
	rewarden = "5 Хромосом"
...
/datum/special/baronsurvive
	...
	descriptionen = "Убедись, что барон выживет. Выживите."
...
/datum/special/amusermany
	...
	descriptionen = "Будучи новичком на этом пути, вы должны набраться опыта и хорошей репутации. Выживи, и ты получишь +1 CHR за каждого клиента, которого обслужишь сегодня вечером."
	reward = ""
	rewarden = ""
...
/datum/special/gloves
	...
	descriptionen = "У тебя какие-то гнусные планы. Вам пришлось купить перчатки, чтобы не оставлять отпечатков пальцев."
...
/datum/special/screamerimmunity
	...
	descriptionen = "Однажды тебя сильно укусил крикун, но ты так и не стал одним из них."
...
/datum/special/screamercurse
	...
	descriptionen = "Ведьма наложила на тебя ужасное заклятие - когда ты умрешь, ты наверняка станешь крикуном."
...
/datum/special/robusta
	...
	descriptionen = "Годы напряженных боев и тренировок, направленных на то, чтобы потешить свое навязчивое эго, сделали тебя невероятно лучше в бою."
...
/datum/special/squireadult
	...
	descriptionen = "Какой позор! Ты взрослый мужчина и все еще оруженосец."
...
/datum/special/jesterdecree
	...
	descriptionen = "Когда барон в отъезде, вы принимаете решения за него."
...
/datum/special/censormagnum
	...
	descriptionen = "Даже такому сильному человеку, как ты, нужен помощник. Вам помогает пистолет Магнум-66."
/*
/datum/special/succubus
	name = "succubus"
...
/datum/special/archmortus
	...
	descriptionen = "Ты - Архимортус. Сильный, хладнокровный и респектабельный, ты сумел заставить дворянство присвоить тебе этот несуществующий титул."
...
/datum/special/novice
	...
	descriptionen = "Самодисциплина и осторожность помогли вам избежать многих ошибок. У тебя нет пороков."
...
/datum/special/grandma
	...
	descriptionen = "В детстве вам приходилось лечить свою больную бабушку. Ты многое узнала о медицине и хирургии, но твоя бабушка умерла в страшных муках."

/datum/special/fragile
	name = "fragile"
	description = "Você é uma coisinha frágil."
	descriptionen = "Ты хрупкое создание."
...
/datum/special/scaredark
	...
	descriptionen = "Ты же знаешь, какие твари могут таиться в тени. Ты терпеть не можешь находиться в темноте."

/datum/special/youlooksick
	name = "youlooksick"
	description = "You look sick."
	descriptionen = "Ты выглядишь больным."

/datum/special/needhurry
	name = "needhurry"
	description = "No need to hurry. You walk slowly but you don't get tired that much."
	descriptionen = "Не нужно торопиться. Ты идешь медленно, но устаешь не так сильно."
...
/datum/special/sailor
	...
	descriptionen = "В детстве вы познакомились с моряком. Он обещал взять вас с собой в круиз по подземным водам Эвергрина. Но потом он напился и столкнул тебя в унитаз. С тех пор ты смертельно боишься утонуть."

/datum/special/paingain
	name = "paingain"
	description = "Pain has finally transformed into gain. You're in a good physical shape."
	descriptionen = "Боль, наконец, превратилась в выгоду. Ты в хорошей физической форме."
...
/datum/special/piercinggaze
	...
	descriptionen = "Ты видел такое, во что люди никогда бы не поверили. В результате ваш пронзительный взгляд вселяет ужас в их души."

/datum/special/perception
	name = "perception"
	description = "You are able to notice little things fast."
	descriptionen = "Вы способны быстро замечать мелочи."
...
/datum/special/avantgarde
	...
	descriptionen = "Вашему дедушке нравились его эксперименты с авангардными духами. Ты больше не замечаешь вони."

/datum/special/interestingperson
	name = "interestingperson"
	description = "You're an interesting person. -2 and +2 to stats."
	descriptionen = "Ты интересный человек. Случайные -2 и +2 к характеристикам."

/datum/special/badshape
	name = "badshape"
	description = "You should have been paying more attention to yourself. You're in a bad physical shape."
	descriptionen = "Тебе следовало бы уделять себе больше внимания. Ты в плохой физической форме."

/datum/special/wormcrawl
	name = "wormcrawl"
	description = "You are scared of worms and you hate them. No one in the world could make you crawl."
	descriptionen = "Вы боитесь червей и ненавидите их. Никто в мире не смог бы заставить тебя ползти."
...
/datum/special/robustmeister
	...
	descriptionen = "Ты достаточно крепок для мейстера."
...
/datum/special/maleamuser
	...
	descriptionen = "Благодаря твоему хорошенькому личику и игривому характеру, ты заслужила звание забавницы."
...
/datum/special/little_sherif
	...
	descriptionen = "Несмотря на то, что вы, возможно, молоды, ваши справедливые поступки и любовь к закону дали вам возможность стать шерифом."
...
/datum/special/rich
	...
	descriptionen = "Этой ночью у вас есть задание: получите 5000 оболов на консоли продавца и осуществите свою мечту!"
...
/datum/special/rebelsuccessor
	...
	descriptionen = "Ты - мятежный преемник. К черту благородные обычаи."
...
/datum/special/castrated
	...
	descriptionen = "Ты потерял свою мужественность."
...
/datum/special/circusfreak
	...
	descriptionen = "Вас воспитывали странствующие артисты и акробаты. Метание ножей, гимнастика и хождение по канату."
...
/datum/special/doinked
	...
	descriptionen = "У тебя есть что-то лишнее."
